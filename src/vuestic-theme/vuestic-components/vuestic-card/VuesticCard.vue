  ...
  >
    <template v-if="image">
      <img
        ...
        :alt="imageAlt"
      >
      <div v-if="titleOnImage" class="vuestic-card__image-container">
        <img class="card-img-top" :src="image" :alt="imageAlt">
        <div v-if="overlay" class="vuestic-card__image-container__overlay" />
    ...
    <div class="card-body">
      <h5
        ...
        class="vuestic-card__title card-title"
      >
        <slot name="title" />
      </h5>
      <p class="card-text">
