<template>
  <ul
    class="wizard-steps horizontal-steps rich-steps"
  ...
  >
    ...
    >
      <i class="ion ion-md-close step-icon icon-cross" />
      <i class="ion ion-md-checkmark step-icon icon-check" />
      <span class="wizard-step-label ellipsis">
        {{ step.label }}
      </span>
...
<script>
export default {
  name: 'VuesticWizardRichHorizontalIndicator',
  props: {
    steps: {
      type: Array,
      default: () => []
