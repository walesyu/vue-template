<template>
  <div class="vuestic-tree-category">
    <div
      class="vuestic-tree-category__header"
      @click="isOpenCached = ! isOpenCached"
    >
      <div class="vuestic-tree-category__header-checkbox">
        <square-with-icon :icon-class="checkboxIconClass" />
      </div>
      <div
        v-if="$slots.icon"
        class="vuestic-tree-category__header-icon"
      >
        <slot name="icon" />
      </div>
    ...
    <div v-if="isOpenCached" class="vuestic-tree-category__list-container">
